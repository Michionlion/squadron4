...
public class Util {
    ...
    public static Matrix4f createTransformationMatrix(
        ...
        return createTransformationMatrix(
                new Vector3f(x, y, z), new Vector3f(rx, ry, rz), new Vector3f(sx, sy, sz));
    }

    public static Matrix4f createTransformationMatrix(
            float x, float y, float z, float rx, float ry, float rz, float scale) {
        return createTransformationMatrix(
                new Vector3f(x, y, z), new Vector3f(rx, ry, rz), new Vector3f(scale, scale, scale));
    }

    public static Matrix4f createTransformationMatrix(
            float x, float y, float z, float rx, float ry, float rz) {
        return createTransformationMatrix(
                new Vector3f(x, y, z), new Vector3f(rx, ry, rz), new Vector3f(1, 1, 1));
    }

    public static Matrix4f createSpriteTransformationMatrix(
            float x, float y, float rotation, float width, float height, float priority) {
        Matrix4f matrix = new Matrix4f();
        matrix.setIdentity();
        //        Matrix4f.translate(new Vector3f(x+(width/2f), y+(height/2f), priority), matrix,
        // matrix);
